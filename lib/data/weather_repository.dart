...
class WeatherRepository{
   ...
   Future<List<CityModel>>getSearchCity({required String city})=> _weatherApiService.searchCity(city: city, limit: limit, appId: appId);
   Future<CurrentWeatherModel>getCurrentWeather({required double lat, required double lon})=>_weatherApiService.currentWeather(lat: lat, lon: lon, appId: appId,unit: unit);
}